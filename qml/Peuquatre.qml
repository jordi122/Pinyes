...
SplitView {
    ...
    function omplirModels() {
        list_viewpeuquatreComp.model = crosses;     afegirNomsaLlistesOrd("Crosses","colNom");
        list_viewpeuquatreComp.model = primeres;    afegirNomsaLlistesOrd("Primeres","colNom");
        list_viewpeuquatreComp.model = baixos;      afegirNomsaLlistesOrd("Baixos","colNom");
        list_viewpeuquatreComp.model = agulles;     afegirNomsaLlistesOrd("Agulles","colNom");
        list_viewpeuquatreComp.model = contraforts; afegirNomsaLlistesOrd("Contraforts","colNom");
        list_viewpeuquatreComp.model = pinya;       afegirNomsaLlistesOrd("Pinya","colNom");
        embolcallcbItems.currentIndex = intNomPosicio;
        switch (intNomPosicio) {
        case 0:
            list_viewpeuquatreComp.model = pinya;
            break;
        case 1:
            list_viewpeuquatreComp.model = baixos;
            break;
        case 2:
            list_viewpeuquatreComp.model = crosses;
            break;
        case 3:
            list_viewpeuquatreComp.model = agulles;
            break;
        case 4:
            list_viewpeuquatreComp.model = contraforts;
            break;
        case 5:
            list_viewpeuquatreComp.model = primeres;
            break;
        default:
            list_viewpeuquatreComp.model = pinya;
            break;
        ...
        db.transaction(
                    function(tx) {
                        ...
                        for(var j = 0; j < llista.rows.length ; j++) {
                            for(var i = 0; i < list_viewpeuquatreComp.model.count ; i++) {
                                if (list_viewpeuquatreComp.model.get(i).colNom === llista.rows.item(j).colNom) {
                                    list_viewpeuquatreComp.model.remove(i);
                                    break;
                                }
                            }
                        }
    ...
    function afegirNomsaLlistesOrd(posicio,ordreDes) {
        var sentit = "ASC";
        if (list_viewpeuquatreComp.sortIndicatorOrder===1) {
            sentit = "DESC"
        }
        db.transaction(
                    function(tx) {
                        ...
                        list_viewpeuquatreComp.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            ...
                            if (llista2.rows.length ===0) {
                                list_viewpeuquatreComp.model.append({"colNom": llista.rows.item(i).colNom,"espatlla": llista.rows.item(i).espatlla,"mans": llista.rows.item(i).mans})
    ...
    function afegirPinyesaLlistesLocal(tipusPinya) {
        db.transaction(
                    function(tx) {
                        ...
                        list_viewpeuquatre.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            list_viewpeuquatre.model.append({"colNom": llista.rows.item(i).colNom,"data": llista.rows.item(i).data})
                        }
                    }
                    )
    }
            ...
            GroupBox {
                ...
                GridLayout {
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            afegirPinyesaLlistesLocal("llistapeuquatre");
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            list_viewpeuquatre.model.remove(indexTaula2)
                            AccionsBD.esborrarPinya("llistapeuquatre",pinyaActual)
                            indexTaula2=-1
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            list_viewpeuquatre.model = llistapeuquatre;
                            afegirPinyesaLlistesLocal("llistapeuquatre");
                        }
                        itemDelegate: {
                            return itemDelegateCastells
                    ...
                    ToolButton  {
                        ...
                        onClicked: {
                            AccionsBD.buscarRegistreaTaula(text_input1.text,"llistapeuquatre");
                            ...
                            if (text_input1.text==="Nom..." || !xequeig) {
                                ...
                                AccionsBD.backupPinya(text_input1.text,taulaActual,"llistapeuquatre");
                                afegirPinyesaLlistesLocal("llistapeuquatre");
                                barra.color = "green";
