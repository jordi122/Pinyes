...
SplitView {
    ...
    function omplirModels() {
        list_viewquatreComp.model = crosses;     afegirNomsaLlistesOrd("Crosses","colNom");
        list_viewquatreComp.model = primeres;    afegirNomsaLlistesOrd("Primeres","colNom");
        list_viewquatreComp.model = baixos;      afegirNomsaLlistesOrd("Baixos","colNom");
        list_viewquatreComp.model = agulles;     afegirNomsaLlistesOrd("Agulles","colNom");
        list_viewquatreComp.model = contraforts; afegirNomsaLlistesOrd("Contraforts","colNom");
        list_viewquatreComp.model = pinya;       afegirNomsaLlistesOrd("Pinya","colNom");
        embolcallcbItems.currentIndex = intNomPosicio;
        switch (intNomPosicio) {
        case 0:
            list_viewquatreComp.model = pinya;
            break;
        case 1:
            list_viewquatreComp.model = baixos;
            break;
        case 2:
            list_viewquatreComp.model = crosses;
            break;
        case 3:
            list_viewquatreComp.model = agulles;
            break;
        case 4:
            list_viewquatreComp.model = contraforts;
            break;
        case 5:
            list_viewquatreComp.model = primeres;
            break;
        default:
            list_viewquatreComp.model = pinya;
            break;
        ...
        db.transaction(
                    function(tx) {
                        ...
                        for(var j = 0; j < llista.rows.length ; j++) {
                            for(var i = 0; i < list_viewquatreComp.model.count ; i++) {
                                if (list_viewquatreComp.model.get(i).colNom === llista.rows.item(j).colNom) {
                                    list_viewquatreComp.model.remove(i);
                                    break;
                                }
                            }
                        }
    ...
    function afegirNomsaLlistesOrd(posicio,ordreDes) {
        var sentit = "ASC";
        if (list_viewquatreComp.sortIndicatorOrder===1) {
            sentit = "DESC"
        }
        db.transaction(
                    function(tx) {
                        ...
                        list_viewquatreComp.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            ...
                            if (llista2.rows.length ===0) {
                                list_viewquatreComp.model.append({"colNom": llista.rows.item(i).colNom,"espatlla": llista.rows.item(i).espatlla,"mans": llista.rows.item(i).mans})
    ...
    function afegirPinyesaLlistesLocal(tipusPinya) {
        db.transaction(
                    function(tx) {
                        ...
                        list_viewquatre.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            list_viewquatre.model.append({"colNom": llista.rows.item(i).colNom,"data": llista.rows.item(i).data})
                        }
                    }
                    )
    }
            ...
            GroupBox {
                ...
                GridLayout {
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            afegirPinyesaLlistesLocal("llistaquatre");
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            list_viewquatre.model.remove(indexTaula2)
                            AccionsBD.esborrarPinya("llistaquatre",pinyaActual)
                            indexTaula2=-1
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            list_viewquatre.model = llistaquatre;
                            afegirPinyesaLlistesLocal("llistaquatre");
                        }
                        itemDelegate: {
                            return itemDelegateCastells
                    ...
                    ToolButton  {
                        ...
                        onClicked: {
                            AccionsBD.buscarRegistreaTaula(text_input1.text,"llistaquatre");
                            ...
                            if (text_input1.text==="Nom..." || !xequeig) {
                                ...
                                AccionsBD.backupPinya(text_input1.text,taulaActual,"llistaquatre");
                                afegirPinyesaLlistesLocal("llistaquatre");
                                barra.color = "green";
