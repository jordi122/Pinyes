...
SplitView {
    ...
    function omplirModels() {
        list_viewfolretresComp.model = crosses;     afegirNomsaLlistesOrd("Crosses","colNom");
        list_viewfolretresComp.model = primeres;    afegirNomsaLlistesOrd("Primeres","colNom");
        list_viewfolretresComp.model = baixos;      afegirNomsaLlistesOrd("Baixos","colNom");
        list_viewfolretresComp.model = agulles;     afegirNomsaLlistesOrd("Agulles","colNom");
        list_viewfolretresComp.model = contraforts; afegirNomsaLlistesOrd("Contraforts","colNom");
        list_viewfolretresComp.model = pinya;       afegirNomsaLlistesOrd("Pinya","colNom");
        embolcallcbItems.currentIndex = intNomPosicio;
        switch (intNomPosicio) {
        case 0:
            list_viewfolretresComp.model = pinya;
            break;
        case 1:
            list_viewfolretresComp.model = baixos;
            break;
        case 2:
            list_viewfolretresComp.model = crosses;
            break;
        case 3:
            list_viewfolretresComp.model = agulles;
            break;
        case 4:
            list_viewfolretresComp.model = contraforts;
            break;
        case 5:
            list_viewfolretresComp.model = primeres;
            break;
        default:
            list_viewfolretresComp.model = pinya;
            break;
        ...
        db.transaction(
                    function(tx) {
                        ...
                        for(var j = 0; j < llista.rows.length ; j++) {
                            for(var i = 0; i < list_viewfolretresComp.model.count ; i++) {
                                if (list_viewfolretresComp.model.get(i).colNom === llista.rows.item(j).colNom) {
                                    list_viewfolretresComp.model.remove(i);
                                    break;
                                }
                            }
                        }
    ...
    function afegirNomsaLlistesOrd(posicio,ordreDes) {
        var sentit = "ASC";
        if (list_viewfolretresComp.sortIndicatorOrder===1) {
            sentit = "DESC"
        }
        db.transaction(
                    function(tx) {
                        ...
                        list_viewfolretresComp.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            ...
                            if (llista2.rows.length ===0) {
                                list_viewfolretresComp.model.append({"colNom": llista.rows.item(i).colNom,"espatlla": llista.rows.item(i).espatlla,"mans": llista.rows.item(i).mans})
    ...
    function afegirPinyesaLlistesLocal(tipusPinya) {
        db.transaction(
                    function(tx) {
                        ...
                        list_viewfolretres.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            list_viewfolretres.model.append({"colNom": llista.rows.item(i).colNom,"data": llista.rows.item(i).data})
                        }
                    }
                    )
    }
            ...
            GroupBox {
                ...
                GridLayout {
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            afegirPinyesaLlistesLocal("llistafolretres");
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            list_viewfolretres.model.remove(indexTaula2)
                            AccionsBD.esborrarPinya("llistafolretres",pinyaActual)
                            indexTaula2=-1
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            list_viewfolretres.model = llistafolretres;
                            afegirPinyesaLlistesLocal("llistafolretres");
                        }
                        itemDelegate: {
                            return itemDelegateCastells
                    ...
                    ToolButton  {
                        ...
                        onClicked: {
                            AccionsBD.buscarRegistreaTaula(text_input1.text,"llistafolretres");
                            ...
                            if (text_input1.text==="Nom..." || !xequeig) {
                                ...
                                AccionsBD.backupPinya(text_input1.text,taulaActual,"llistafolretres");
                                afegirPinyesaLlistesLocal("llistafolretres");
                                barra.color = "green";
