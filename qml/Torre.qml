...
SplitView {
    ...
    function omplirModels() {
        list_viewtorreComp.model = crosses;     afegirNomsaLlistesOrd("Crosses","colNom");
        list_viewtorreComp.model = primeres;    afegirNomsaLlistesOrd("Primeres","colNom");
        list_viewtorreComp.model = baixos;      afegirNomsaLlistesOrd("Baixos","colNom");
        list_viewtorreComp.model = agulles;     afegirNomsaLlistesOrd("Agulles","colNom");
        list_viewtorreComp.model = contraforts; afegirNomsaLlistesOrd("Contraforts","colNom");
        list_viewtorreComp.model = pinya;       afegirNomsaLlistesOrd("Pinya","colNom");
        embolcallcbItems.currentIndex = intNomPosicio;
        switch (intNomPosicio) {
        case 0:
            list_viewtorreComp.model = pinya;
            break;
        case 1:
            list_viewtorreComp.model = baixos;
            break;
        case 2:
            list_viewtorreComp.model = crosses;
            break;
        case 3:
            list_viewtorreComp.model = agulles;
            break;
        case 4:
            list_viewtorreComp.model = contraforts;
            break;
        case 5:
            list_viewtorreComp.model = primeres;
            break;
        default:
            list_viewtorreComp.model = pinya;
            break;
        ...
        db.transaction(
                    function(tx) {
                        ...
                        for(var j = 0; j < llista.rows.length ; j++) {
                            for(var i = 0; i < list_viewtorreComp.model.count ; i++) {
                                if (list_viewtorreComp.model.get(i).colNom === llista.rows.item(j).colNom) {
                                    list_viewtorreComp.model.remove(i);
                                    break;
                                }
                            }
                        }
    ...
    function afegirNomsaLlistesOrd(posicio,ordreDes) {
        var sentit = "ASC";
        if (list_viewtorreComp.sortIndicatorOrder===1) {
            sentit = "DESC"
        }
        db.transaction(
                    function(tx) {
                        ...
                        list_viewtorreComp.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            ...
                            if (llista2.rows.length ===0) {
                                list_viewtorreComp.model.append({"colNom": llista.rows.item(i).colNom,"espatlla": llista.rows.item(i).espatlla,"mans": llista.rows.item(i).mans})
    ...
    function afegirPinyesaLlistesLocal(tipusPinya) {
        db.transaction(
                    function(tx) {
                        ...
                        list_viewtorre.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            list_viewtorre.model.append({"colNom": llista.rows.item(i).colNom,"data": llista.rows.item(i).data})
                        }
                    }
                    )
    }
            ...
            GroupBox {
                ...
                GridLayout {
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            afegirPinyesaLlistesLocal("llistatorre");
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            list_viewtorre.model.remove(indexTaula2)
                            AccionsBD.esborrarPinya("llistatorre",pinyaActual)
                            indexTaula2=-1
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            list_viewtorre.model = llistatorre;
                            afegirPinyesaLlistesLocal("llistatorre");
                        }
                        itemDelegate: {
                            return itemDelegateCastells
                    ...
                    ToolButton  {
                        ...
                        onClicked: {
                            AccionsBD.buscarRegistreaTaula(text_input1.text,"llistatorre");
                            ...
                            if (text_input1.text==="Nom..." || !xequeig) {
                                ...
                                AccionsBD.backupPinya(text_input1.text,taulaActual,"llistatorre");
                                afegirPinyesaLlistesLocal("llistatorre");
                                barra.color = "green";
