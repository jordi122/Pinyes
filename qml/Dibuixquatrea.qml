    ...
    ScrollView {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                z: 2
                visible: true
                Posicio { id: primeresPilar; x: 0; y: 245; anchors.verticalCenterOffset: 123; text: "1 Pilar"
                    onButtonClick: {
                        if (nomComponent !="insertat") {
                            if (text !="") {
                                list_viewquatreaComp.model.remove(indexTaula)

                                AccionsBD.insertarRegistreaPinya("primeresPilar",text,taulaActual);}
            ...
            Rectangle {
                ...
                z: 2
                visible: true
                Posicio { id: dretaPilar; x: 0; y: 245; anchors.verticalCenterOffset: 120; text: "Dreta Pilar"
                    onButtonClick: {
                        if (nomComponent !="insertat") {
                            if (text !="") {
                                list_viewquatreaComp.model.remove(indexTaula)

                                AccionsBD.insertarRegistreaPinya("dretaPilar",text,taulaActual);}
                            nomComponent = "insertat"
                            indexTaula = -1
                        }}
                    onDoublebuttonClick: {
            ...
            Rectangle {
                ...
                rotation: 90
                visible: true
                Posicio { id: esquerraPilar; anchors.verticalCenterOffset: 120; text: "Esquerra Pilar"
                    onButtonClick: {
                        if (nomComponent !="insertat") {
                            if (text !="") {
                                list_viewquatreaComp.model.remove(indexTaula)

                                AccionsBD.insertarRegistreaPinya("esquerraPilar",text,taulaActual);}
                            nomComponent = "insertat"
                            indexTaula = -1
                        }}
                    onDoublebuttonClick: {
            ...
            Rectangle {
                ...
                rotation: 180
                visible: true
                Posicio { id: agullaPilar; x: 0; y: 245; anchors.verticalCenterOffset: 123; text: "Agulla Pilar"
                    border.color: "red"
                    rotation: 180
                    onButtonClick: {
                        if (nomComponent !="insertat") {
                            if (text !="") {
                                ...
                                AccionsBD.insertarRegistreaPinya("agullaPilar",text,taulaActual);}
                            nomComponent = "insertat"
                            indexTaula = -1
                        }}
                    onDoublebuttonClick: {
            ...
            Rectangle {
                ...
                Posicio {
                    ...
                    onButtonClick: {
                        if (nomComponent !="insertat") {
                            if (text !="") {
                                AccionsBD.insertarRegistreaPinya("baixAgulla",text,taulaActual);}
                            nomComponent = "insertat"
                            indexTaula = -1
                        }}
                    onDoublebuttonClick: {
...
//            }
    ...
    Rectangle {
        ...
        Button {
            ...
            width: 30
            onClicked: {
                AccionsBD.netejarTaula("quatrea")
                primeresPilar.text = ""
                esquerraPilar.text = ""
                agullaPilar.text = ""
                dretaPilar.text = ""
    ...
    function boto2() {
        ...
        else
        {
            ...
            primeresPilar.text = AccionsBD.trobaNomperPosicio("primeresPilar",pinyaActual)
