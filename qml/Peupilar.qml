...
SplitView {
    ...
    function omplirModels() {
        list_viewpeupilarComp.model = crosses;     afegirNomsaLlistesOrd("Crosses","colNom");
        list_viewpeupilarComp.model = primeres;    afegirNomsaLlistesOrd("Primeres","colNom");
        list_viewpeupilarComp.model = baixos;      afegirNomsaLlistesOrd("Baixos","colNom");
        list_viewpeupilarComp.model = agulles;     afegirNomsaLlistesOrd("Agulles","colNom");
        list_viewpeupilarComp.model = contraforts; afegirNomsaLlistesOrd("Contraforts","colNom");
        list_viewpeupilarComp.model = pinya;       afegirNomsaLlistesOrd("Pinya","colNom");
        embolcallcbItems.currentIndex = intNomPosicio;
        switch (intNomPosicio) {
        case 0:
            list_viewpeupilarComp.model = pinya;
            break;
        case 1:
            list_viewpeupilarComp.model = baixos;
            break;
        case 2:
            list_viewpeupilarComp.model = crosses;
            break;
        case 3:
            list_viewpeupilarComp.model = agulles;
            break;
        case 4:
            list_viewpeupilarComp.model = contraforts;
            break;
        case 5:
            list_viewpeupilarComp.model = primeres;
            break;
        default:
            list_viewpeupilarComp.model = pinya;
            break;
        ...
        db.transaction(
                    function(tx) {
                        ...
                        for(var j = 0; j < llista.rows.length ; j++) {
                            for(var i = 0; i < list_viewpeupilarComp.model.count ; i++) {
                                if (list_viewpeupilarComp.model.get(i).colNom === llista.rows.item(j).colNom) {
                                    list_viewpeupilarComp.model.remove(i);
                                    break;
                                }
                            }
                        }
    ...
    function afegirNomsaLlistesOrd(posicio,ordreDes) {
        var sentit = "ASC";
        if (list_viewpeupilarComp.sortIndicatorOrder===1) {
            sentit = "DESC"
        }
        db.transaction(
                    function(tx) {
                        ...
                        list_viewpeupilarComp.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            ...
                            if (llista2.rows.length ===0) {
                                list_viewpeupilarComp.model.append({"colNom": llista.rows.item(i).colNom,"espatlla": llista.rows.item(i).espatlla,"mans": llista.rows.item(i).mans})
    ...
    function afegirPinyesaLlistesLocal(tipusPinya) {
        db.transaction(
                    function(tx) {
                        ...
                        list_viewpeupilar.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            list_viewpeupilar.model.append({"colNom": llista.rows.item(i).colNom,"data": llista.rows.item(i).data})
                        }
                    }
                    )
    }
            ...
            GroupBox {
                ...
                GridLayout {
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            afegirPinyesaLlistesLocal("llistapeupilar");
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            list_viewpeupilar.model.remove(indexTaula2)
                            AccionsBD.esborrarPinya("llistapeupilar",pinyaActual)
                            indexTaula2=-1
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            list_viewpeupilar.model = llistapeupilar;
                            afegirPinyesaLlistesLocal("llistapeupilar");
                        }
                        itemDelegate: {
                            return itemDelegateCastells
                    ...
                    ToolButton  {
                        ...
                        onClicked: {
                            AccionsBD.buscarRegistreaTaula(text_input1.text,"llistapeupilar");
                            ...
                            if (text_input1.text==="Nom..." || !xequeig) {
                                ...
                                AccionsBD.backupPinya(text_input1.text,taulaActual,"llistapeupilar");
                                afegirPinyesaLlistesLocal("llistapeupilar");
                                barra.color = "green";
