...
SplitView {
    ...
    function omplirModels() {
        list_viewfolretorreComp.model = crosses;     afegirNomsaLlistesOrd("Crosses","colNom");
        list_viewfolretorreComp.model = primeres;    afegirNomsaLlistesOrd("Primeres","colNom");
        list_viewfolretorreComp.model = baixos;      afegirNomsaLlistesOrd("Baixos","colNom");
        list_viewfolretorreComp.model = agulles;     afegirNomsaLlistesOrd("Agulles","colNom");
        list_viewfolretorreComp.model = contraforts; afegirNomsaLlistesOrd("Contraforts","colNom");
        list_viewfolretorreComp.model = pinya;       afegirNomsaLlistesOrd("Pinya","colNom");
        embolcallcbItems.currentIndex = intNomPosicio;
        switch (intNomPosicio) {
        case 0:
            list_viewfolretorreComp.model = pinya;
            break;
        case 1:
            list_viewfolretorreComp.model = baixos;
            break;
        case 2:
            list_viewfolretorreComp.model = crosses;
            break;
        case 3:
            list_viewfolretorreComp.model = agulles;
            break;
        case 4:
            list_viewfolretorreComp.model = contraforts;
            break;
        case 5:
            list_viewfolretorreComp.model = primeres;
            break;
        default:
            list_viewfolretorreComp.model = pinya;
            break;
        ...
        db.transaction(
                    function(tx) {
                        ...
                        for(var j = 0; j < llista.rows.length ; j++) {
                            for(var i = 0; i < list_viewfolretorreComp.model.count ; i++) {
                                if (list_viewfolretorreComp.model.get(i).colNom === llista.rows.item(j).colNom) {
                                    list_viewfolretorreComp.model.remove(i);
                                    break;
                                }
                            }
                        }
    ...
    function afegirNomsaLlistesOrd(posicio,ordreDes) {
        var sentit = "ASC";
        if (list_viewfolretorreComp.sortIndicatorOrder===1) {
            sentit = "DESC"
        }
        db.transaction(
                    function(tx) {
                        ...
                        list_viewfolretorreComp.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            ...
                            if (llista2.rows.length ===0) {
                                list_viewfolretorreComp.model.append({"colNom": llista.rows.item(i).colNom,"espatlla": llista.rows.item(i).espatlla,"mans": llista.rows.item(i).mans})
    ...
    function afegirPinyesaLlistesLocal(tipusPinya) {
        db.transaction(
                    function(tx) {
                        ...
                        list_viewfolretorre.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            list_viewfolretorre.model.append({"colNom": llista.rows.item(i).colNom,"data": llista.rows.item(i).data})
                        }
                    }
                    )
    }
            ...
            GroupBox {
                ...
                GridLayout {
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            afegirPinyesaLlistesLocal("llistafolretorre");
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            list_viewfolretorre.model.remove(indexTaula2)
                            AccionsBD.esborrarPinya("llistafolretorre",pinyaActual)
                            indexTaula2=-1
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            list_viewfolretorre.model = llistafolretorre;
                            afegirPinyesaLlistesLocal("llistafolretorre");
                        }
                        itemDelegate: {
                            return itemDelegateCastells
                    ...
                    ToolButton  {
                        ...
                        onClicked: {
                            AccionsBD.buscarRegistreaTaula(text_input1.text,"llistafolretorre");
                            ...
                            if (text_input1.text==="Nom..." || !xequeig) {
                                ...
                                AccionsBD.backupPinya(text_input1.text,taulaActual,"llistafolretorre");
                                afegirPinyesaLlistesLocal("llistafolretorre");
                                barra.color = "green";
