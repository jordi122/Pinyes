...
SplitView {
    ...
    function omplirModels() {
        list_viewfolrepilarComp.model = crosses;     afegirNomsaLlistesOrd("Crosses","colNom");
        list_viewfolrepilarComp.model = primeres;    afegirNomsaLlistesOrd("Primeres","colNom");
        list_viewfolrepilarComp.model = baixos;      afegirNomsaLlistesOrd("Baixos","colNom");
        list_viewfolrepilarComp.model = agulles;     afegirNomsaLlistesOrd("Agulles","colNom");
        list_viewfolrepilarComp.model = contraforts; afegirNomsaLlistesOrd("Contraforts","colNom");
        list_viewfolrepilarComp.model = pinya;       afegirNomsaLlistesOrd("Pinya","colNom");
        embolcallcbItems.currentIndex = intNomPosicio;
        switch (intNomPosicio) {
        case 0:
            list_viewfolrepilarComp.model = pinya;
            break;
        case 1:
            list_viewfolrepilarComp.model = baixos;
            break;
        case 2:
            list_viewfolrepilarComp.model = crosses;
            break;
        case 3:
            list_viewfolrepilarComp.model = agulles;
            break;
        case 4:
            list_viewfolrepilarComp.model = contraforts;
            break;
        case 5:
            list_viewfolrepilarComp.model = primeres;
            break;
        default:
            list_viewfolrepilarComp.model = pinya;
            break;
        ...
        db.transaction(
                    function(tx) {
                        ...
                        for(var j = 0; j < llista.rows.length ; j++) {
                            for(var i = 0; i < list_viewfolrepilarComp.model.count ; i++) {
                                if (list_viewfolrepilarComp.model.get(i).colNom === llista.rows.item(j).colNom) {
                                    list_viewfolrepilarComp.model.remove(i);
                                    break;
                                }
                            }
                        }
    ...
    function afegirNomsaLlistesOrd(posicio,ordreDes) {
        var sentit = "ASC";
        if (list_viewfolrepilarComp.sortIndicatorOrder===1) {
            sentit = "DESC"
        }
        db.transaction(
                    function(tx) {
                        ...
                        list_viewfolrepilarComp.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            ...
                            if (llista2.rows.length ===0) {
                                list_viewfolrepilarComp.model.append({"colNom": llista.rows.item(i).colNom,"espatlla": llista.rows.item(i).espatlla,"mans": llista.rows.item(i).mans})
    ...
    function afegirPinyesaLlistesLocal(tipusPinya) {
        db.transaction(
                    function(tx) {
                        ...
                        list_viewfolrepilar.model.clear();
                        for(var i = 0; i < llista.rows.length; i++) {
                            list_viewfolrepilar.model.append({"colNom": llista.rows.item(i).colNom,"data": llista.rows.item(i).data})
                        }
                    }
                    )
    }
            ...
            GroupBox {
                ...
                GridLayout {
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            afegirPinyesaLlistesLocal("llistafolrepilar");
                    ...
                    ToolButton {
                        ...
                        onClicked: {
                            list_viewfolrepilar.model.remove(indexTaula2)
                            AccionsBD.esborrarPinya("llistafolrepilar",pinyaActual)
                            indexTaula2=-1
                    ...
                    TableView {
                        ...
                        Component.onCompleted: {
                            list_viewfolrepilar.model = llistafolrepilar;
                            afegirPinyesaLlistesLocal("llistafolrepilar");
                        }
                        itemDelegate: {
                            return itemDelegateCastells
                    ...
                    ToolButton  {
                        ...
                        onClicked: {
                            AccionsBD.buscarRegistreaTaula(text_input1.text,"llistafolrepilar");
                            ...
                            if (text_input1.text==="Nom..." || !xequeig) {
                                ...
                                AccionsBD.backupPinya(text_input1.text,taulaActual,"llistafolrepilar");
                                afegirPinyesaLlistesLocal("llistafolrepilar");
                                barra.color = "green";
